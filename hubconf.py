"""PyTorch Hub entry point for Voice.Me TTS models."""
dependencies = [
...
def tts(model_name='tts_models/en/ljspeech/tacotron2-DCA',
    ...
    Example:
        >>> synthesizer = torch.hub.load('voiceme-ai/TTS', 'tts', source='github')
...
if __name__ == '__main__':
    synthesizer = torch.hub.load('voiceme-ai/TTS:dev', 'tts', source='github')
