"""Loss functions for TTS models including L1, MSE, SSIM, BCE, guided attention, forward sum, MDN, and model-specific losses for Tacotron, GlowTTS, AlignTTS, VITS, and ForwardTTS."""
import math
