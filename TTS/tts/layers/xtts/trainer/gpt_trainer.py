...
class GPTArgs(XttsArgs):
    ...
    tokenizer_file: str = ""
    mel_norm_file: str = "https://models.voiceme.ai/v0.14.0_models/mel_norms.pth"
    dvae_checkpoint: str = ""
    xtts_checkpoint: str = ""
...
class GPTTrainer(BaseTTS):
    def __init__(self, config: Coqpit):
        ...
        if self.args.gpt_checkpoint:
            ...
            # deal with Voice.Me Trainer exported model
            if "model" in gpt_checkpoint.keys() and "config" in gpt_checkpoint.keys():
                logger.info(" > Voice.Me Trainer checkpoint detected! Converting it!")
