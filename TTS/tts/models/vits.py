"""VITS model: end-to-end TTS with flow-based generation."""
...
class Vits(BaseTTS):
    ...
    def load_fairseq_checkpoint(
        ...
        Args:
            config (Coqpit): Voice.Me TTS model config.
    ...
    def export_onnx(self, output_path: str = "voiceme_vits.onnx", verbose: bool = True):
