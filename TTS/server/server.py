#!flask/bin/python
"""Voice.Me TTS HTTP server.

Provides a Flask-based REST API and web UI for text-to-speech synthesis,
including MaryTTS-compatible endpoints for drop-in integration.
"""
