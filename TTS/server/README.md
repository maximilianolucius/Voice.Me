# Voice.Me TTS demo server
Before you use the server, make sure you [install](https://github.com/voiceme-ai/TTS/tree/dev#install-tts)) Voice.Me TTS properly. Then, you can follow the steps below.

**Note:** If you install Voice.Me TTS using ```pip```, you can also use the ```tts-server``` end point on the terminal.
