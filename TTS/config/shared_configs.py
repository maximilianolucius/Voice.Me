"""Shared configuration dataclasses for Voice.Me TTS.

Defines the base configuration classes for audio processing, dataset definitions,
and training parameters that are shared across all TTS, vocoder, and encoder models.
"""
...
class BaseTrainingConfig(TrainerConfig):
    """Base config to define the basic Voice.Me TTS training parameters that are shared
