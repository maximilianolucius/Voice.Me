"""Voice.Me TTS configuration loading and management.

Provides utilities to load, register, and validate TTS model configurations
from JSON and YAML files, mapping them to the appropriate Coqpit config classes.
"""
