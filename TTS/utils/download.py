"""Voice.Me TTS file download utilities.

Adapted from https://github.com/pytorch/audio/

Provides functions for streaming downloads, file validation via hash checks,
archive extraction, and Kaggle dataset downloads.
"""
