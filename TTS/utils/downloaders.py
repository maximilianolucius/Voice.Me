"""Voice.Me TTS dataset downloaders.

Provides convenience functions to download and extract common speech datasets
such as LJSpeech, VCTK, LibriTTS, Thorsten DE, M-AILABS, and TWEB.
"""
