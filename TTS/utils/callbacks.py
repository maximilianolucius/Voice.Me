"""Voice.Me TTS trainer callbacks.

Provides the :class:`TrainerCallback` class that dispatches lifecycle events
(init, epoch, train step, keyboard interrupt) to the model, criterion, and
optimizer if they implement the corresponding hook methods.
"""


class TrainerCallback:
    """Dispatches training lifecycle hooks to model, criterion, and optimizer.

    Each static method checks whether the model (or its ``.module`` for
    DataParallel), criterion, and optimizer implement the corresponding hook
