"""Voice.Me TTS PyTorch-based audio transforms.

Provides :class:`TorchSTFT`, a GPU-accelerated STFT module for computing
spectrograms and mel-spectrograms using PyTorch, enabling efficient batched
audio processing during training.
"""
