"""Voice.Me TTS AudioProcessor.

Provides the :class:`AudioProcessor` class that wraps all audio processing
operations needed for TTS training and inference, including spectrogram
computation, normalization, Griffin-Lim reconstruction, pitch extraction,
silence trimming, and waveform I/O.
"""
