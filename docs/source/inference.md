...
![cli.gif](https://github.com/voiceme-ai/TTS/raw/main/images/tts_cli.gif)

After the installation, Voice.Me TTS provides a CLI interface for synthesizing speech using pre-trained models. You can either use your own model or the release models under Voice.Me TTS.

Listing released Voice.Me TTS models.
...
## On the Demo Server - `tts-server`
 ...
 <!-- <img src="https://raw.githubusercontent.com/voiceme-ai/TTS/main/images/demo_server.gif" height="56"/> -->
![server.gif](https://github.com/voiceme-ai/TTS/raw/main/images/demo_server.gif)

You can boot up a demo Voice.Me TTS server to run an inference with your models. Note that the server is not optimized for performance
...
# List available Voice.Me TTS models
...
This way, you can clone voices by using any model in Voice.Me TTS.
