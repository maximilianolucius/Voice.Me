...
Voice.Me YourTTS is a multi-speaker and multi-lingual TTS model that can perform voice conversion and zero-shot speaker adaptation.
It can also learn a new language or voice with a ~ 1 minute long audio clip. This is a big open gate for training
TTS models in low-resources languages. Voice.Me YourTTS uses VITS as the backbone architecture coupled with a speaker encoder model.

## Important resources & papers
- Voice.Me YourTTS: https://arxiv.org/abs/2112.02418
