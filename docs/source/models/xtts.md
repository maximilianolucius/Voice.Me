...
This is the same model that powers [Voice.Me Studio](https://voiceme.ai/), and [Voice.Me API](https://docs.voiceme.ai/docs), however we apply
...
### License
This model is licensed under [Voice.Me Public Model License](https://voiceme.ai/cpml).

### Contact
Come and join in our community. We're active on [Discord](https://discord.gg/fBC58unbKE) and [Twitter](https://twitter.com/voiceme_ai).
You can also mail us at info@voiceme.ai.

### Inference

#### Voice.Me TTS Command line
...
You can check all Voice.Me available speakers with the following command:
...
# using the default version set in Voice.Me TTS
tts = TTS("tts_models/multilingual/multi-dataset/xtts_v2", gpu=True)

# using a specific version
# see the branch names for versions on https://huggingface.co/voiceme/XTTS-v2/tree/main
...
- Preprocessing of the uploaded audio or audio files in Voice.Me TTS formatter
...
1. Install   Voice.Me TTS following the instructions available [here](https://tts.readthedocs.io/en/dev/installation.html#installation).
...
A recipe for `XTTS_v2` GPT encoder training using `LJSpeech` dataset is available at https://github.com/voiceme-ai/TTS/tree/dev/recipes/ljspeech/xtts_v1/train_gpt_xtts.py
