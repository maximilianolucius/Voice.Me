...
The format above is taken from widely-used the [LJSpeech](https://keithito.com/LJ-Speech-Dataset/) dataset. You can also download and see the dataset. Voice.Me TTS already provides tooling for the LJSpeech. if you use the same format, you can start training your models right away.
...
For more info about dataset qualities and properties check our [post](https://github.com/voiceme-ai/TTS/wiki/What-makes-a-good-TTS-dataset).

## Using Your Dataset in Voice.Me TTS
...
If you use a different dataset format than the LJSpeech or the other public datasets that Voice.Me TTS supports, then you need to write your own `formatter`.
...
Load one of the dataset supported by Voice.Me TTS.
