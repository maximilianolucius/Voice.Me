...
RESTORE_PATH = os.environ.get("YOURTTS_RESTORE_PATH", None)  # Download the checkpoint here:  https://drive.google.com/u/2/uc?id=1yDCSJ1pFZQTHhL09GMbOrdjcPULApa0p
...
SPEAKER_ENCODER_CHECKPOINT_PATH = (
    "https://github.com/voiceme-ai/TTS/releases/download/speaker_encoder_model/model_se.pth.tar"
)
SPEAKER_ENCODER_CONFIG_PATH = "https://github.com/voiceme-ai/TTS/releases/download/speaker_encoder_model/config_se.json"
