...
VCTK_PATH = os.environ.get("VCTK_PATH", "/path/to/VCTK_NEW_16khz_removed_silence_silero_vad/")  # download:  https://datashare.ed.ac.uk/bitstream/handle/10283/3443/VCTK-Corpus-0.92.zip
RIR_SIMULATED_PATH = os.environ.get("RIR_SIMULATED_PATH", "/path/to/RIRS_NOISES/simulated_rirs/")  # download: https://www.openslr.org/17/
MUSAN_PATH = os.environ.get("MUSAN_PATH", "/path/to/musan/")  # download: https://www.openslr.org/17/
